...
(async () => {
  ...
  if (process.argv[2] === 'verify') {
    ...
    // FINAL player-placed positions of the rear hazard lenses (group-local),
    // dialed in with the U/I/J/K/N/M nudge keys and confirmed by the player.
    // These are the ground truth — hazSpots in index.html must match them
    // exactly.
    const final = [
