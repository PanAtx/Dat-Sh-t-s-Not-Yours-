...
check('step top is 0.36 (GZ 0.3 + 0.06 thin lip)', world.top === 0.36, 'top=' + world.top);
...
check('point ON mat -> top 0.36', stepTopAt(baseX, matY) === 0.36);
...
check('ground NPC (z=0.3) over mat lifts to 0.36', applyLift(0.3, baseX, matY) === 0.36);
