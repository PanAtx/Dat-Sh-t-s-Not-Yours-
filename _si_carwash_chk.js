...
check(
  "addCreature: RED GARDEN HOSE (18 unit segments, r 0.045, 0xc2452d — red pops against the dark green 0x4d7a3a lawn) from the house spigot to his fist",
  (() => {
    const i = src.indexOf('case "carwasher":');
    if (i < 0) return false;
    const seg = src.slice(i, i + 5200);
    return (
      seg.indexOf("CylinderGeometry(0.045, 0.045, 1, 8)") >= 0 &&
