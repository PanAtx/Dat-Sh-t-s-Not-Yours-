...
let m = speakWith(rich, 'dog shit!', 'male', 0.9);
...
let f = speakWith(rich, 'Ow! That hurt!', 'female', 1.1);
...
let mFb = speakWith(onlyFemale, 'dog shit!', 'male', 0.9);
...
let fFb = speakWith(onlyMale, 'Ow! That hurt!', 'female', 1.1);
...
let mSel = speakWith(rich, 'This bag is heavy!', 'male', 0.9);
...
let fSel = speakWith(rich, 'Ow! That hurt!', 'female', 1.1);
