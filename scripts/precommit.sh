...
if git diff --cached --unified=0 | grep -Eq "APP_VERSION|\"version\"|dsnboy-shell-v"; then
  # This commit already carries a version change - just make sure every
  # version point agrees with the new APP_VERSION.
